...
(defn- update-pursuit
  ...
  [x-vel y-vel gx-vel gy-vel object sensor source]
  ...
  (receive-focus
   ...
   (let [fixation (g/find-first #(and (= (:name %) "fixation")
     ...
     (cond
       ...
       ;; shift.
       pursuit-target
       (reset! (:buffer component) (target->pursuit pursuit-target component))
