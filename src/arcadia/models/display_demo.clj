...
(def ^:private colors [nil java.awt.Color/red java.awt.Color/cyan
                       java.awt.Color/magenta java.awt.Color/orange java.awt.Color/green java.awt.Color/blue])
     ...
     [["Fixations" nil
      ...
      [[(i# (-> % :content (d/filter-elements :name "object-location")))
       ...
       [(i# (-> % :content (d/filter-elements :name "fixation")))
        ...
        :text-size 1.2 :y-offset -10 :color java.awt.Color/green]]]
      ["Object Location Map"
      ...
      ["Red"
       (remember-previous
        (i# (if (-> % :focus (d/element-matches? :name "object" :color "red"))
              (inc (:previous %))
              (:previous %)))
        0) :caption-color java.awt.Color/red :caption-bold? true]
      ["Gray"
       (remember-previous
        (i# (if (-> % :focus (d/element-matches? :name "object" :color nil))
              (inc (:previous %))
              (:previous %)))
        0) :caption-color java.awt.Color/gray :caption-bold? true]
      [" " :center? true :text-background java.awt.Color/black :text-size 0.8]
